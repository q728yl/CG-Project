...
private:
    ...
    void processNode(aiNode* node, const aiScene* scene)
    {
        ...
        for (unsigned int i = 0; i < node->mNumMeshes; i++)
        {
          ...
          /*  meshes_in.push_back(processMesh(mesh, scene)[1]);*/
    ...
    Mesh processMesh(aiMesh* mesh, const aiScene* scene)
    {
      ...
      //  vector<Vertex> vertices_in;
        ...
        for (unsigned int i = 0; i < mesh->mNumVertices; i++)
        {
            ...
            if (mesh->mTextureCoords[0]) // does the mesh contain texture coordinates?
            {
               ...
               /// vertex_in.Tangent = vector;
                ...
                vertex_out.Bitangent = vector;
               // vertex_in.Bitangent = vector;
            }
            else {
        ...
        /*vector<Mesh> res;*/
       // res.push_back(Mesh(vertices_out, indices, textures));
       // res.push_back(Mesh(vertices_in, indices, textures));
        // return a mesh object created from the extracted mesh data
        return Mesh(vertices_out, indices, textures);
    }
